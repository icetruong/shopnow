...
/**
 * Thân xử lý payment.processed. Tách khỏi PaymentProcessedListener để:
 *  - @Transactional chạy qua proxy (được gọi từ bean listener);
 *  - khi lỗi, DB rollback xong exception mới nổi lên cho SafeConsumer log & nuốt.
 */
@Service
@Slf4j
