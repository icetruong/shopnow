...
/** Bộ filter cho GET /admin/shipments. Mỗi method trả null khi tham số null -> bỏ qua điều kiện đó. */
public class ShipmentSpecification {
    ...
    public static Specification<Shipment> hasFailureReason(String failureReason) {
        return (root, query, cb) ->
                failureReason == null ? null : cb.equal(root.get("failureReason"), failureReason);
    }

    /** Tìm gần đúng theo trackingCode HOẶC orderCode. */
